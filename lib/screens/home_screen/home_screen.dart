                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      scrollDirection: Axis
                          .horizontal, // Set the desired scroll direction here
                      child: Row(
                          ...
                          return Card(
                            ...
                            child: Container(
                              ...
                              padding: EdgeInsets.fromLTRB(
                                  4, 8, 4, 8), // Set the desired width here
                              child: ListTile(
                      ...
                      child: ListView(
                        children: [
                            ...
                            children: [
                              ...
                              XCards(onPress: (){
                                ...
                                Navigator.pushNamedAndRemoveUntil(context,
                                  ...
                                  icon: 'assets/icons/chat.svg', xtext: 'Chats'),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              XCards(onPress: (){debugPrint('Datesheet');}, icon: 'assets/icons/datesheet.svg', xtext: 'Datesheet'),
                              XCards(onPress: (){debugPrint('Result');}, icon: 'assets/icons/result.svg', xtext: 'Result'),
...
class XCards extends StatelessWidget {
  const XCards({Key? key, required this.onPress, required this.icon, required this.xtext}) : super(key: key);
